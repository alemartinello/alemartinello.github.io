...
## Substantial transmission of SARS-CoV-2 through casual contact in retail stores: Evidence from matched administrative microdata on card payments and testing<br>*PNAS (2024) 121 (17)*

*with Niels Johannesen, Bjørn Bjørnsson Meyer, Emil Toft Vestergaard, Asger Lau Andersen, and Thais Lærkholm Jensen*

**Abstract**<br>
This paper presents quasiexperimental evidence of Covid-19 transmission
through casual contact between customers in retail stores. For a large
sample of individuals in Denmark, we match card payment data, indicating
exactly where and when each individual made purchases, with Covid-19
test data, indicating when each individual was tested and whether the
test was positive. The resulting dataset identifies more than 100,000
instances where an infected individual made a purchase in a store and,
in each instance, allows us to track the infection dynamics of other
individuals who made purchases in the same store around the same time.
We estimate transmissions by comparing the infection rate of exposed
customers, who made a purchase within 5 min of an infected individual,
and nonexposed customers, who made a purchase in the same store 16 to 30
min before. We find that exposure to an infected individual in a store
increases the infection rate by around 0.12 percentage points (P \<
0.001) between day 3 and day 7 after exposure. The estimates imply that
transmissions in stores contributed around 0.04 to the reproduction
number for the average infected individual and significantly more in the
period where Omicron was the dominant variant.
...
## Placement Optimization in Refugee Resettlement<br>*Operations Research (2021) 69(5):1468-1486*

*with Andrew C. Trapp, Alexander Teytelboym, Tommy Andersson, and Narges Ahani*

**In the media:** [Financial
Times](https://www.ft.com/content/9332fffc-ec57-11e8-89c8-d36339d835c0?fbclid=IwAR2cd9EpI8bArWOdKWf3K-uRNVKXul1w5q5jgWs5IfEt9fMiUvNQ09QWrtk),
[The
Atlantic](https://www.theatlantic.com/international/archive/2019/04/how-technology-could-revolutionize-refugee-resettlement/587383/),
[Dagens
Nyheter](https://www.dn.se/ekonomi/nytt-datorprogram-kan-hjalpa-flyktingar-att-fa-jobb/)
(Swedish),
[SVT](https://www.svt.se/nyheter/lokalt/skane/sa-skulle-nyanlanda-lattare-fa-jobb-i-sverige)
(Swedish)
...
[Link]((https://swopec.hhs.se/lunewp/abs/lunewp2018_023.htm))
:::


::: {.callout-note collapse="true"}
## Long-Run Saving Dynamics: Evidence from Unexpected Inheritances<br>*The Review of Economics and Statistics (2020)*
...
[*Link*](https://raw.githubusercontent.com/alemartinello/long-run-saving-dynamics/master/paper/paper.pdf), [Code](https://github.com/JeppeDruedahl/LongRunSavingDynamics),
[Appendix](https://raw.githubusercontent.com/alemartinello/long-run-saving-dynamics/master/paper/appendix.pdf)
:::


::: {.callout-note collapse="true"}
## Measurement error in income and schooling, and the bias for linear estimators<br>*Journal of Labor Economics 35, no. 4 (2017)*
*with Paul Bingley*
...
[Link](http://www.journals.uchicago.edu/doi/full/10.1086/692539), [Ungated version
(pre-print)](https://github.com/alemartinello/Papers/blob/e8201ab262f700ec5d5f49a4c2c72fea8ec54783/measurement-error/paper.pdf)
:::

::: {.callout-note collapse="true"}
## Mental retirement and schooling <br>European Economic Review, 63:292-298, 2013
*with Paul Bingley*
...
[Link](http://www.sciencedirect.com/science/article/pii/S0014292113000111)
:::
...
**[Uncertainty and the real economy: Evidence from
Denmark](https://www.nationalbanken.dk/en/publications/Pages/2020/11/Working-Paper-Uncertainty-and-the-real-economy-Evidence-from-Denmark.aspx)**\
with Mikkel Bess, Erik Grenestam, and Jesper Pedersen\
Abstract **In the media:**
[Børsen](https://borsen.dk/nyheder/okonomi/nationalbanken-lancerer-nyt-frygtindeks)
(Danish)
...
**[Seeing Through the Spin: The Effect of News Sentiment on Firms\'
Stock Market
Performance](http://www.nationalbanken.dk/en/publications/Documents/2019/10/Working%20Paper%20nr.%20141.pdf)**\
...
**[The Effects of Schooling on Wealth Accumulation Approaching
Retirement](http://swopec.hhs.se/lunewp/abs/lunewp2017_009.htm)**\
with Paul Bingley\
Abstract
...
**[Dynamic Refugee
Matching](https://swopec.hhs.se/lunewp/abs/lunewp2018_007.htm)**\
...
**[Does Liquidity Substitute for Unemployment Insurance? Evidence from
the Introduction of Home Equity Loans in Denmark]()**\
